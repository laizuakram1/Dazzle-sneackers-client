      ...
      <div>
        <footer className="footer p-10 bg-gray-800 text-white mt-32">
          <div>
            ...
            <p>
              <span className="text-2xl font-bold text-red-500">DAZZLE.</span>
              <br />
              INTERNATIONAL QUALITY FOOTWEAR
            </p>
            <div className="grid grid-cols-4 gap-3">
              ...
              <BsTwitter className="text-4xl bg-black text-white p-2 rounded-md hover:bg-red-500 duration-500 ease-in cursor-pointer" />
            </div>
          </div>
          <div>
