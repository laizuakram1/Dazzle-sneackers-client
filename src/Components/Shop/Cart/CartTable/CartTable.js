                ...
                <table className="table w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>$210</td>
                            <td>
                               <span className='border py-3 px-5 rounded cursor-pointer'><HiMinusSm onClick={decrease} className='inline mr-2'/>{counter}<BsPlus onClick={increase} className='inline ml-2'/></span>
